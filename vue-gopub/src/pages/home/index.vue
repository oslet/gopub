            ...
            <div style="height: 30px;margin-top:5px;margin-bottom:-7px">
              ...
              <div style="float:left;margin-left:10px;" class="infobox-data">
                <span class="infobox-data-number">
                  <strong style="color: #8492A6">{{hostsum}}</strong>&nbsp个服务器
                </span>
              </div>
              ...
              <div style="float:left;margin-left:10px" class="infobox-data">
                <span class="infobox-data-number">
                  <strong style="color: #FF4949">{{totalmem}}</strong>&nbsp位用户
                </span>
              </div>
              ...
              <div style="float:left;margin-left:10px" class="infobox-data">
                <span class="infobox-data-number">
                  <strong style="color: #324057">{{totalproject}}</strong>&nbsp个项目
                </span>
              </div>
              ...
              <div style="float:left;margin-left:10px" class="infobox-data">
                <span class="infobox-data-number">
                  <strong style="color: #20A0FF">{{totalpub}}</strong>&nbsp次发布
                </span>
              </div>
              ...
              <div style="float:left;margin-left:10px" class="infobox-data">
                <span class="infobox-data-number">
                  <strong style="color: #20A0FF">{{currentrelease}}</strong>&nbspwww环境版本号
                </span>
              </div>
              ...
              <div style="float:left;margin-left:10px" class="infobox-data">
                <span class="infobox-data-number">
                  <strong style="color: #20A0FF">{{currentbeta}}</strong>&nbspbeta环境版本号
                </span>
              </div>
...
import { port_task , port_getver} from "common/port_uri";
export default {
  data() {
    return {
  ...
  methods: {
    ...
    get_echarts_instance() {
      ...
      require(["echarts"], echarts => {
        ...
        this.getDataOfCurrentrelease();
        this.getDataOfCurrentBeta();
      });
    },
    create_totalmen() {
      this.$http
    ...
    getDataOfCurrentrelease(){
        this.$http.get(port_getver.getrelease).then(
            res => {
                console.log(res);
                if (res.data.code === 0) {
                    this.currentrelease = res.data.data;
                }
            },
            err => {
                console.log(err);
    ...
    getDataOfCurrentBeta(){
        this.$http.get(port_getver.getbeta).then(
            res => {
                console.log(res);
                if (res.data.code === 0) {
                    this.currentbeta = res.data.data;
                }
            },
            err => {
                console.log(err);
